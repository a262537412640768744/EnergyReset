...
const Table = [
    ...
    [
        ...
        "购买200个生产器A<sub>0</sub><sup>8</sup>", "通过所有A<sub>1</sub>挑战",
        "购买所有A<sub>1</sub>升级", "解锁A<sub>2</sub>",
        "A<sub>2</sub>重置", "达到e1000000能源A<sub>0</sub>",
    ]
]
let hover = [-1, 0]
...
<div class="massage">
    ...
    <br>
    获得成就00,01,02,03,05,07,12,15,20会解锁一个推荐
</div>
<table>
    <tbody>
        <tr>
        ...
        <tr>
            ...
            <td ${achievement[2][3] ? "style='background: #00007f'" : ""} onmouseover="hover = [2, 3]">23<br><br>费我一辈子</td>
            <td ${achievement[2][4] ? "style='background: #00007f'" : ""} onmouseover="hover = [2, 4]">24<br><br>还是升级</td>
            <td ${achievement[2][5] ? "style='background: #00007f'" : ""} onmouseover="hover = [2, 5]">25<br><br>催更！</td>
